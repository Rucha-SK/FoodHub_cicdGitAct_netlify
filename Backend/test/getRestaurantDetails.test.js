...
//   describe('GET /api/restaurant-manager/details/:managerId', () => {
...
//         chai.request(app)
//           .get(`/api/restaurant-manager/details/${mockRestaurant.manager}`)
//           .end((err, res) => {
...
//       chai.request(app)
//         .get('/api/restaurant-manager/details/nonexistentManagerId')
//         .end((err, res) => {
//           // Restore the stub after the test
//           sinon.restore();
...
//       chai.request(app)
//         .get('/api/restaurant-manager/details/errorManagerId')
//         .end((err, res) => {
//           // Restore the stub after the test
//           sinon.restore();
...
// //         const managerId = new mongoose.Types.ObjectId('654a49bd6cb3ab7e00860748');
// //         const name = 'Test Dish';
// //         const price = 15;
  
// //         // Read the file as a Buffer
// //         const fileBuffer = fs.readFileSync('C:\\Users\\RIYA\\Desktop\\React\\FoodOrderSys\\Frontend\\src\\logo.svg');
...
// //         // Optionally, you can check the database state or other properties of the response
// //         const updatedRestaurant = await Restaurant.findOne({ manager: managerId });
...
// //         const fileBuffer = fs.readFileSync('C:\\Users\\RIYA\\Desktop\\React\\FoodOrderSys\\Frontend\\src\\logo.svg');
// //         const managerId = new mongoose.Types.ObjectId('654a49bd6cb3ab7e00860789');
// //         const response = await chai
// //             .request(app)
// //             .post('/api/restaurant-manager/add-menu-item')
// //             .field('managerId', managerId.toString())
